"""
Django settings for CareerGPS project.
...
SECRET_KEY = 'django-insecure-o4n48-mst^z@tljmb=f5afu-fm!#g(cqm&ua+jqpr(+^y5r@4('
...
# DEFAULT_FROM_EMAIL = 'CareerGPS <noreply@careergps.com>'